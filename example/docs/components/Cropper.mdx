...
import { RotateCoordinatesExample } from '../../src/components/examples/RotateCoordinatesExample';
...
- **Returns:**
  ...
  :::note Important notice
	If an image is rotated, the coordinates are calculated relative to an image bounding box.
	<RotateCoordinatesExample/>
	:::
