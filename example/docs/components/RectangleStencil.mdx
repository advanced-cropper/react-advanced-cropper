...
- **Details:**
	...
	The object with the current cropper state.
...
- **Details:**
	...
	The object with the current cropper transitions.


### `onResize`
- **Type:** `(event: ResizeEvent) => void`

- **Details:**

	The callback that should be called on stencil resize.
...
- **Details:**
	...
	The callback that should be called on stencil resize end.
...
- **Details:**
	...
	The callback that should be called on stencil move.
...
- **Details:**
	...
	The callback that should be called on stencil move end.
