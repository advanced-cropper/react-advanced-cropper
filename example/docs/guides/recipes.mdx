...
The list of available props varies from one stencil component to another. The props of default stencils are available in the documentation ([RectangleStencil](/docs/components/RectangleStencil), [CircleStencil](/docs/components/CircleStencil))
