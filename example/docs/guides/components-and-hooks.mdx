...
This component is used to give the user possibility to resize and move image by mouse and touch. It handles the touch, mouse and wheel events and produces
