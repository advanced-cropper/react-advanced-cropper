...
properties, therefore this hook provides the default settings (ones that `createDefaultSettings` function provides) and add default `autoZoom` postprocess function.
